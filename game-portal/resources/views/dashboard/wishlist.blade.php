...
<div class="container py-5">
    ...
    <div class="dashboard-header mb-5">
        ...
        <p class="dashboard-subtitle">Games you want to play</p>
    </div>
    ...
    <div class="dashboard-layout">
        ...
        <aside class="dashboard-sidebar">
            <nav class="sidebar-nav">
                ...
                <a href="{{ route('user.wishlist') }}" class="nav-item" style="background: rgba(255, 255, 255, 0.05); border-color: rgba(0, 247, 255, 0.3); color: var(--primary-cyan);">
                    <span class="nav-label">Wishlist</span>
                    <span class="nav-count" id="wishlistCount">{{ $wishlistGames->total() }}</span>
                </a>
        ...
        <main class="dashboard-content">
            ...
            <div class="content-section">
                @if($wishlistGames->count() > 0)
                    <div class="games-grid" id="gamesGrid">
                        ...
                        <div class="game-card-wrapper" id="game-{{ $game->id }}">
                            ...
                            <button type="button" class="btn-remove" data-game-id="{{ $game->id }}" data-game-title="{{ $game->title }}" title="Remove from wishlist">
                ...
                @else
                    <div id="emptyState" style="display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; padding: 4rem 2rem; min-height: 400px;">
                        <h2 style="color: #fff; font-size: 1.5rem; margin-bottom: 1rem;">Your Wishlist is Empty</h2>
                        <p style="color: rgba(255, 255, 255, 0.6); margin-bottom: 2rem;">Discover games you want to play!</p>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    removeButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            if (!confirm(`Remove "${gameTitle}" from your wishlist?`)) {
                return;
            }
            ...
            .then(data => {
                if (data.success) {
                    ...
                    setTimeout(() => {
                        ...
                        showNotification(data.message || 'Game removed from wishlist', 'success');
                    }, 300);
                } else {
